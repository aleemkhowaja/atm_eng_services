...
public interface IsoMessageListener<T extends IsoMessage>
{
    ...
    /**
     * Returns <code>true</code> if given message can be handled by
     * {@link #onMessage(ChannelHandlerContext, IsoMessage)}.
     *
    ...
    /**
     * Handles the message. If message should not be processed by any other
     * handlers then this method should return <code>false</code>.
     *
