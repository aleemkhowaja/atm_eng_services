...
public interface ConnectorConfigurer<C extends AtmConnectorConfiguration, B extends AbstractBootstrap>
{

    /**
     * Hook added before completion of the bootstrap configuration.
     * <p>
     * This method is called during {@link AbstractIso8583Connector#init()}
     * phase.
     * </p>
     *
     * @param bootstrap AbstractBootstrap to configure
     * @param configuration A {@link ConnectorConfiguration} to use
     * @implSpec This implementation does no thing
     */
     ...
     * {@link com.github.kpavlov.jreactive8583.netty.pipeline.Iso8583ChannelInitializer#initChannel(io.netty.channel.Channel)}
     * phase.
     * </p>
     *
